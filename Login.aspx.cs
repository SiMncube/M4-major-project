...
namespace M4_major_project
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string checkUser = "select count(*) from Customer where emailID='" + textBox1.Value + "'";
            ...
            {
                conn.Open();
                string checkPassword = "select password from Customer where password='" + textBox2.Value + "'";
