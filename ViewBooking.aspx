...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="291px" AutoGenerateRows="False" CellPadding="4" DataKeyNames="summaryID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" style="margin-left: 0px" DataMember="DefaultView">
            ...
            <RowStyle BackColor="#EFF3FB" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:group7ConnectionString %>" DeleteCommand="DELETE FROM [BookingSummary] WHERE [summaryID] = @original_summaryID AND [emailID] = @original_emailID AND [dateIn] = @original_dateIn AND [dateOut] = @original_dateOut AND [numberOfNights] = @original_numberOfNights AND (([bookingMethod] = @original_bookingMethod) OR ([bookingMethod] IS NULL AND @original_bookingMethod IS NULL)) AND (([bookingStatus] = @original_bookingStatus) OR ([bookingStatus] IS NULL AND @original_bookingStatus IS NULL)) AND [amountDue] = @original_amountDue" InsertCommand="INSERT INTO [BookingSummary] ([emailID], [dateIn], [dateOut], [numberOfNights], [bookingMethod], [bookingStatus], [amountDue]) VALUES (@emailID, @dateIn, @dateOut, @numberOfNights, @bookingMethod, @bookingStatus, @amountDue)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [BookingSummary] WHERE ([summaryID] = @summaryID)" UpdateCommand="UPDATE [BookingSummary] SET [emailID] = @emailID, [dateIn] = @dateIn, [dateOut] = @dateOut, [numberOfNights] = @numberOfNights, [bookingMethod] = @bookingMethod, [bookingStatus] = @bookingStatus, [amountDue] = @amountDue WHERE [summaryID] = @original_summaryID AND [emailID] = @original_emailID AND [dateIn] = @original_dateIn AND [dateOut] = @original_dateOut AND [numberOfNights] = @original_numberOfNights AND (([bookingMethod] = @original_bookingMethod) OR ([bookingMethod] IS NULL AND @original_bookingMethod IS NULL)) AND (([bookingStatus] = @original_bookingStatus) OR ([bookingStatus] IS NULL AND @original_bookingStatus IS NULL)) AND [amountDue] = @original_amountDue">
                        <DeleteParameters>
                        ...
                        <SelectParameters>
                            <asp:ControlParameter ControlID="viewBookingTextBox" Name="summaryID" PropertyName="Text" Type="Int32" />
                        </SelectParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="emailID" Type="String" />
                            <asp:Parameter DbType="Date" Name="dateIn" />
